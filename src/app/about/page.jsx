    ...
    <>
      <div className={`${showForm ? 'blur-sm pointer-events-none select-none' : ''} flex flex-col items-center w-full overflow-x-hidden`}>
        ...
        <div className="w-full max-w-7xl mx-auto px-2 md:px-4">
          ...
          <div className="flex justify-center items-center gap-6 md:gap-30 flex-col md:flex-row">
            <div className='bg-teal-600/20 backdrop-blur-md border border-teal-100/20 p-4 md:p-5 rounded-2xl w-full md:w-auto' data-aos='fade-down'>
