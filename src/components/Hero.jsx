...
const Hero = (props) => {
  return (
    <div className='relative w-screen h-[100vh] rounded-2xl p-10 shadow-2xl mt-10 overflow-auto'>
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center h-full md:p-10 p-0 md:gap-10 gap-5">
        ...
        {props.form=='true'?
                <form className="bg-teal-300/10 backdrop-blur-md border border-teal-100/20 shadow-xl p-6 md:p-8 rounded-xl w-full max-w-lg space-y-6">
