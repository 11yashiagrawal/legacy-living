...
const Card = (props) => {
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-2xl flex flex-col justify-center items-center space-y-3 max-w-[400px] p-4 ${props.readmore=='true'?'text-left':'text-center'} ${props.lr=='true'?'relative':''}`} data-aos='fade-down'>
